...
def encode_embeds(embed_encoder: tuple[PreTrainedModel, PreTrainedTokenizer], texts: list[str], device: torch.device, model_type: str, prompt_images: list[Image.Image] | None = None) -> torch.FloatTensor:
    with torch.no_grad():
        match model_type:
            case "sd3":
